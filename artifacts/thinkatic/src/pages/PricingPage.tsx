...
export default function PricingPage() {
  ...
  return (
    <Layout>
      <div className="pt-28 pb-24 min-h-screen text-white" style={{ background: "#050811" }}>
        {/* Subtle background glow */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-96 bg-[radial-gradient(ellipse_at_top,rgba(37,99,235,0.15),transparent_70%)] pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 md:px-12 relative z-10">
          ...
          <div className="flex flex-col items-center text-center mb-12">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-blue-500/20 bg-blue-500/10 mb-5">
              <Sparkles size={13} className="text-[#47A3FF]" />
              <span className="text-[11px] font-mono tracking-[0.2em] uppercase text-[#47A3FF] font-semibold">
            ...
            <h1 className="font-display font-black text-3xl sm:text-4xl md:text-6xl tracking-tight leading-[1.05] mb-5">
              ...
              <span className="bg-gradient-to-r from-white via-[#93C5FD] to-[#47A3FF] bg-clip-text text-transparent">
                Service Catalogs
              </span>
            </h1>

            <p className="text-base md:text-lg text-white/60 max-w-2xl leading-relaxed mb-8">
            ...
            <div className="inline-flex p-1.5 rounded-2xl bg-white/[0.04] border border-white/10 shadow-2xl backdrop-blur-xl">
              <button
                ...
                className={`flex items-center gap-2 px-5 py-3 rounded-xl font-bold text-xs sm:text-sm tracking-wide transition-all duration-200 ${
                  activeCatalog === "ai"
                    ? "bg-[#2563EB] text-white shadow-[0_0_24px_rgba(37,99,235,0.45)]"
          ...
          {activeCatalog === "ai" && (
            ...
            >
              {/* Cover Banner */}
              <div className="relative rounded-3xl border border-blue-500/20 bg-gradient-to-br from-[#0B1A3A]/80 via-[#071126]/90 to-[#040915] p-7 md:p-10 mb-14 overflow-hidden shadow-2xl">
                <div className="absolute top-0 right-0 w-80 h-80 bg-[radial-gradient(circle,rgba(71,163,255,0.12),transparent_70%)] pointer-events-none" />
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
                  <div className="max-w-2xl">
                    <div className="flex items-center gap-2 text-xs font-mono text-[#47A3FF] mb-2 uppercase tracking-widest">
                  ...
                  <div className="rounded-2xl p-5 border border-blue-400/20 bg-blue-500/5 md:min-w-[280px]">
                    <p className="text-[11px] font-mono text-white/40 line-through mb-1">
                      Don't say: "AI Development Company"
                    </p>
                    <p className="text-xs font-semibold text-white/90 mb-2">
                      Say: <span className="text-[#47A3FF] font-bold">"We Build AI Employees That Automate Your Business."</span>
                    </p>
              ...
              <div className="mb-16">
                <div className="text-center mb-8">
                  <span className="text-[10px] font-mono tracking-[0.25em] text-[#47A3FF] uppercase font-bold">
                    WEBSITE PRICING STRUCTURE
                  </span>
                  <h3 className="text-xl md:text-3xl font-display font-bold text-white mt-1">
                  ...
                  {AI_ENGAGEMENT_TIERS.map((tier) => (
                    <div
                      ...
                      className={`relative rounded-2xl p-6 border transition-all duration-200 ${
                        tier.isPopular
                          ? "bg-gradient-to-b from-[#2563EB]/15 to-[#2563EB]/5 border-[#47A3FF]/40 shadow-[0_8px_30px_rgba(37,99,235,0.2)]"
                          : "bg-white/[0.02] border-white/8 hover:border-white/15"
                      }`}
                    >
                      {tier.isPopular && (
                        <div className="absolute -top-3 left-6">
                          <span className="px-3 py-0.5 rounded-full text-[10px] font-bold tracking-wider uppercase bg-[#2563EB] text-white">
                            RECOMMENDED
                          </span>
                        </div>
                      )}
                      <p className="text-xs font-bold font-mono tracking-wider text-white/50 mb-2 uppercase">
                        {tier.name}
                      </p>
                    ...
                    return (
                      <div
                        ...
                        className={`relative rounded-3xl p-7 md:p-8 border flex flex-col justify-between transition-all duration-200 ${
                          pkg.isRecommended
                            ? "bg-gradient-to-b from-[#11244A]/90 to-[#08132B]/90 border-blue-500/40 shadow-[0_12px_40px_rgba(37,99,235,0.25)]"
                            : "bg-white/[0.025] border-white/10 hover:border-white/20"
                        }`}
                      >
                        {pkg.isRecommended && (
                          <div className="absolute -top-3.5 right-8">
                            <span className="inline-flex items-center gap-1 px-3.5 py-1 rounded-full text-[10px] font-bold tracking-widest uppercase bg-[#2563EB] text-white shadow-lg">
                        ...
                        <div>
                          ...
                          <div className="flex items-center justify-between gap-2 mb-2">
                            <span className="text-[10px] font-mono font-bold tracking-widest uppercase text-[#47A3FF]">
                              {pkg.packageNumber}
                            </span>
                          ...
                          {/* Pricing Box */}
                          <div className="flex items-center gap-4 p-4 rounded-2xl bg-black/40 border border-white/10 mb-5">
                            <div>
                              <span className="text-[10px] font-mono uppercase text-white/40 block">SETUP FEE</span>
                            ...
                            <div>
                              <span className="text-[10px] font-mono uppercase text-white/40 block">ONGOING / MO</span>
                              <span className="text-2xl font-display font-bold text-[#47A3FF]">
                          ...
                          {/* Includes List */}
                          <div className="mb-6">
                            <h5 className="text-[11px] font-mono font-bold uppercase tracking-wider text-white/40 mb-3">
                              INCLUDES
                            </h5>
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                              {pkg.includes.map((inc) => (
                                <div key={inc} className="flex items-center gap-2 text-xs text-white/80">
                                  <CheckCircle2 size={13} className="text-[#47A3FF] shrink-0" />
                                  <span>{inc}</span>
                                </div>
                              ))}
                            </div>
                          ...
                          {pkg.exampleAgents && (
                            <div className="p-4 rounded-xl bg-white/[0.02] border border-white/5 mb-5">
                              <h5 className="text-[10px] font-mono font-bold uppercase tracking-widest text-[#47A3FF] mb-2">
                                EXAMPLE AGENTS
                              </h5>
                          ...
                          {pkg.exampleWorkflow && (
                            <div className="p-4 rounded-xl bg-white/[0.02] border border-white/5 mb-5">
                              ...
                              <div className="text-xs font-mono text-blue-200/90 leading-relaxed bg-black/30 p-2.5 rounded border border-white/5">
                              ...
                              <div className="grid grid-cols-2 gap-1.5 text-xs text-white/70">
                                {pkg.useCases.map((uc) => (
                                  <div key={uc} className="flex items-center gap-1.5">
                                    <span className="w-1.5 h-1.5 rounded-full bg-[#47A3FF]" />
                                    <span>{uc}</span>
                                  </div>
                                ))}
                              </div>
                          ...
                          {pkg.connectsTo && (
                            <div className="p-4 rounded-xl bg-white/[0.02] border border-white/5 mb-5">
                              ...
                              <div className="grid grid-cols-2 gap-1 text-xs text-white/70 mb-2.5">
                          ...
                          {pkg.workflowSteps && (
                            <div className="p-4 rounded-xl bg-white/[0.02] border border-white/5 mb-5">
                              ...
                              <div className="text-[11px] font-mono text-blue-200/90 leading-relaxed bg-black/30 p-2.5 rounded border border-white/5">
                          ...
                          <div className="flex flex-wrap items-center justify-between gap-3 pt-3 border-t border-white/5 text-xs text-white/50 mb-6">
                            <div>
                              <span className="text-[10px] font-mono uppercase block text-white/30">IDEAL CUSTOMER</span>
                              <span className="font-semibold text-white/80">{pkg.idealCustomer}</span>
                            </div>
                            {pkg.bestOutcome && (
                              <div className="text-right">
                                <span className="text-[10px] font-mono uppercase block text-white/30">BEST OUTCOME</span>
                        ...
                        <div className="pt-2">
                          <button
                            ...
                            className={`w-full py-3.5 px-6 rounded-xl font-bold text-xs tracking-wider uppercase flex items-center justify-center gap-2 transition-all duration-150 ${
                              pkg.isRecommended
                                ? "bg-[#2563EB] text-white hover:bg-blue-600 shadow-[0_0_20px_rgba(37,99,235,0.4)]"
                          ...
                          {checkoutPlan?.name === pkg.name && (
                            <motion.div
                              ...
                              className="mt-4 p-4 rounded-xl bg-black/60 border border-blue-500/30"
                            >
                              <div className="flex items-center justify-between mb-3 text-xs">
                                <span className="font-semibold text-white">Setup Payment: ${pkg.setupPrice.toLocaleString()}</span>
                                <span className="text-white/40 text-[10px]">Secure PayPal Capture</span>
                              </div>
              ...
              <div className="mb-16 rounded-3xl border border-white/10 bg-white/[0.02] p-6 md:p-8">
                <div className="mb-6">
                  <span className="text-[10px] font-mono tracking-[0.25em] text-[#47A3FF] uppercase font-bold">
                    CATALOG OVERVIEW
                  </span>
                    ...
                    <tbody className="divide-y divide-white/5 text-xs">
                      {AI_CATALOG_OVERVIEW.map((item) => (
                        <tr key={item.id} className="hover:bg-white/[0.02] transition-colors">
                          <td className="py-3.5 px-4 font-mono text-white/40">{item.id}</td>
                          <td className="py-3.5 px-4 font-bold text-white flex items-center gap-2">
                            <span>{item.package}</span>
                            {item.isBestOverall && (
                              <span className="text-[9px] px-2 py-0.5 rounded-full bg-blue-500/20 text-[#47A3FF] font-semibold">
                                ★ BEST OVERALL
                              </span>
                            )}
                          </td>
                          <td className="py-3.5 px-4 text-white/70">{item.coreService}</td>
                          <td className="py-3.5 px-4 font-mono font-bold text-white">{item.setupPrice}</td>
                          <td className="py-3.5 px-4 font-mono font-bold text-[#47A3FF]">{item.monthlyPrice}</td>
                          <td className="py-3.5 px-4 text-white/60">{item.bestFor}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
                ...
                <div className="mt-6 pt-5 border-t border-white/5 grid grid-cols-1 md:grid-cols-3 gap-4 text-xs text-white/60">
                  <div className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#47A3FF] mt-1.5 shrink-0" />
          ...
          {activeCatalog === "scaleos" && (
            ...
            >
              ...
              <div className="relative rounded-3xl border border-blue-500/20 bg-gradient-to-br from-[#07132B]/90 via-[#050C1B] to-[#03060C] p-7 md:p-10 mb-14 overflow-hidden shadow-2xl">
                <div className="absolute top-0 right-0 w-96 h-96 bg-[radial-gradient(circle,rgba(37,99,235,0.15),transparent_70%)] pointer-events-none" />
                <div className="max-w-3xl relative z-10">
                  ...
                  <h2 className="text-3xl md:text-5xl font-display font-black text-white mb-2">
                    Thinkatic <span className="text-[#47A3FF]">ScaleOS</span>
                  </h2>
                  <p className="text-sm md:text-base text-white/80 font-medium leading-relaxed mb-6">
                    {SCALEOS_OVERVIEW.pitch}
                  </p>

                  {/* Motto & Company Line */}
                  <div className="flex flex-wrap items-center gap-4 text-xs font-mono text-white/60 mb-6">
                  ...
                  <div className="p-4 sm:p-5 rounded-2xl bg-blue-950/40 border border-blue-500/30">
                    <p className="text-xs sm:text-sm font-semibold text-white/90 italic leading-relaxed">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-8 pt-8 border-t border-white/10 relative z-10">
                  {SCALEOS_OVERVIEW.stats.map((stat, i) => (
                    <div key={i} className="p-4 rounded-2xl bg-white/[0.02] border border-white/5">
                      <div className="text-3xl font-display font-black text-[#47A3FF] mb-1">
                        {stat.value}
                      </div>
                      <div className="text-[10px] font-mono text-white/50 uppercase tracking-wider leading-tight">
                        {stat.label}
                      </div>
                    </div>
                  ))}
                ...
                {/* Pipeline Bar */}
                <div className="mt-6 pt-4 flex flex-wrap items-center gap-2 text-xs font-mono text-white/70">
                  <span className="text-white/40 uppercase tracking-wider text-[10px]">LIFECYCLE:</span>
                  {SCALEOS_OVERVIEW.pipeline.map((step, idx) => (
                    <div key={step} className="flex items-center gap-2">
                      <span className="px-2 py-0.5 rounded bg-white/5 text-white/80 border border-white/5">
                        {step}
                      </span>
              ...
              <div className="mb-16">
                <div className="text-center mb-10">
                  ...
                  <p className="text-xs md:text-sm text-white/60 max-w-xl mx-auto mt-2">
                  ...
                  {SCALEOS_TIERS.map((tier) => (
                    <div
                      ...
                      className={`relative rounded-3xl p-7 border flex flex-col justify-between transition-all duration-200 ${
                        tier.isMostPopular
                          ? "bg-gradient-to-b from-[#11244A]/95 to-[#07132B]/95 border-[#47A3FF]/50 shadow-[0_12px_45px_rgba(37,99,235,0.3)]"
                          : "bg-white/[0.025] border-white/10 hover:border-white/20"
                      }`}
                    >
                      {tier.isMostPopular && (
                        <div className="absolute -top-3.5 left-1/2 -translate-x-1/2">
                          <span className="px-4 py-1 rounded-full text-[10px] font-bold tracking-widest uppercase bg-[#2563EB] text-white shadow-lg">
                            ★ MOST POPULAR
                          </span>
                        </div>
                      )}
                      ...
                      <div>
                        {/* Header */}
                        <div className="mb-4">
                          <p className="text-[9px] font-mono font-bold text-white/40 uppercase tracking-widest mb-1.5">
                            {tier.subtitle}
                          </p>
                          <div className="flex items-baseline justify-between gap-2">
                            ...
                            <span className="text-2xl md:text-3xl font-display font-black text-[#47A3FF]">
                              {tier.price}
                            </span>
                          </div>
                        ...
                        <div className="space-y-4 my-6">
                          {tier.pillars.map((pillar) => (
                            <div key={pillar.title} className="p-3.5 rounded-xl bg-white/[0.02] border border-white/5">
                              <h5 className="text-[10px] font-mono font-bold uppercase tracking-wider text-[#47A3FF] mb-2">
                                {pillar.title}
                              </h5>
                              <ul className="space-y-1.5 text-xs text-white/80">
                                {pillar.items.map((it) => (
                                  <li key={it} className="flex items-start gap-2">
                                    <span className="text-[#47A3FF] mt-0.5 text-xs">•</span>
                                    <span>{it}</span>
                                  </li>
                                ))}
                              </ul>
                      ...
                      <div className="pt-4 border-t border-white/5">
                        <div className="mb-4">
                          ...
                          <p className="text-[11px] text-[#47A3FF] font-mono mt-0.5">
                            {tier.summaryPrice}
                          </p>
                        </div>
                        ...
                        <Link href="/contact">
                          <button
                            className={`w-full py-3 px-5 rounded-xl font-bold text-xs tracking-wider uppercase flex items-center justify-center gap-2 transition-colors ${
                              tier.isMostPopular
                                ? "bg-[#2563EB] text-white hover:bg-blue-600 shadow-lg shadow-blue-500/25"
                                : "bg-white/10 hover:bg-white/15 text-white border border-white/10"
                            }`}
                          >
                    ...
                    <tbody className="divide-y divide-white/5 text-xs">
                      {SCALEOS_MATRIX.map((row, idx) => (
                        <tr key={idx} className="hover:bg-white/[0.02] transition-colors">
                          <td className="py-3 px-4 font-semibold text-white/90">{row.feature}</td>
                          <td className="py-3 px-4 text-white/70 font-mono">{row.starter}</td>
                          <td className="py-3 px-4 font-mono font-bold text-[#47A3FF]">{row.growth}</td>
                          <td className="py-3 px-4 text-white/90 font-mono font-bold">{row.enterprise}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
              ...
              <div className="mb-16 rounded-3xl border border-blue-500/20 bg-gradient-to-b from-white/[0.03] to-transparent p-6 md:p-8">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="pl-8 pr-3 py-1.5 rounded-xl bg-black/40 border border-white/10 text-xs text-white placeholder-white/40 focus:outline-none focus:border-blue-400"
                      />
                    </div>
                  </div>
                </div>
                    ...
                    <tbody className="divide-y divide-white/5 text-xs">
                      {filteredProjects.map((proj) => (
                        <tr key={proj.id} className="hover:bg-white/[0.02] transition-colors">
                          <td className="py-3 px-4 font-mono text-white/40">{proj.id}</td>
                          <td className="py-3 px-4 font-bold text-white">{proj.project}</td>
                          ...
                          <td className="py-3 px-4 font-mono font-bold text-[#47A3FF]">{proj.payout}</td>
                          <td className="py-3 px-4 text-white/70 font-mono">{proj.cycle}</td>
                          <td className="py-3 px-4 text-white/60">{proj.typeNotes}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
                ...
                <div className="mt-5 p-3.5 rounded-xl bg-black/40 border border-white/5 text-[11px] text-white/40 leading-relaxed">
                  <span className="font-semibold text-white/60 block mb-0.5">Disclaimer:</span>
              ...
              <div className="mb-16 rounded-3xl border border-white/10 bg-white/[0.02] p-6 md:p-8">
                  ...
                  <table className="w-full text-left border-collapse min-w-[550px]">
                    <thead>
                      <tr className="border-b border-blue-500/30 bg-blue-900/20 text-xs font-mono text-[#93C5FD]">
                        <th className="py-3 px-4 font-bold text-white/60">TRADITIONAL APPROACH</th>
                        <th className="py-3 px-4 font-bold text-[#47A3FF]">THINKATIC SCALEOS</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-white/5 text-xs">
                      {ALTERNATIVE_COMPARISON.map((row, i) => (
                        <tr key={i} className="hover:bg-white/[0.02] transition-colors">
                          <td className="py-3 px-4 text-white/60">{row.traditional}</td>
                ...
                <div className="mt-8 p-6 rounded-2xl bg-gradient-to-r from-blue-900/40 via-blue-800/30 to-blue-950/40 border border-blue-500/30 text-center">
                  <span className="text-[10px] font-mono uppercase tracking-[0.25em] text-[#47A3FF] font-bold block mb-1">
          ...
          <div className="mt-16 text-center pt-10 border-t border-white/10">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              <Link href="/contact">
                <button className="px-7 py-3 rounded-full font-bold text-xs tracking-wider uppercase bg-[#2563EB] text-white hover:bg-blue-600 transition-colors shadow-lg shadow-blue-500/20">
                  Book a Discovery Call
                </button>
              </Link>
              <Link href="/request-proposal">
                <button className="px-7 py-3 rounded-full font-bold text-xs tracking-wider uppercase bg-white/5 hover:bg-white/10 text-white border border-white/10 transition-colors">
