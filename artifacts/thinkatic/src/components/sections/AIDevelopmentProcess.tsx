      ...
      <div className="flex flex-col gap-2.5">
        {phase.steps.map((step, si) => (
          ...
          >
            ...
            <span className="text-sm text-white/70 leading-tight">{step}</span>
          </motion.div>
        ))}
      </div>
    </motion.div>
      ...
      <div className="max-w-7xl mx-auto px-8 md:px-16">
        ...
        <div ref={timelineContainerRef} className="relative">
          ...
          <div
            ...
            style={{ background: "rgba(71,163,255,0.08)" }}
          >
            <motion.div
            ...
            >
              <div
                ...
                style={{ background: "linear-gradient(90deg, transparent 0%, rgba(71,163,255,0.15) 20%, rgba(71,163,255,0.15) 80%, transparent 100%)" }}
              />
            </motion.div>
          </div>
            ...
            {phases.map((phase, i) => (
              <div key={phase.label} className="relative flex flex-col">
                ...
                <div
                  ...
                  style={{ background: "#47A3FF", boxShadow: "0 0 8px rgba(71,163,255,0.8)" }}
                />
                ...
                {i < phases.length - 1 && (
                  <div className="flex sm:hidden justify-center my-2">
                    <svg width="12" height="20" viewBox="0 0 12 20" fill="none">
                      <path d="M6 0v16M1 11l5 7 5-7" stroke="#47A3FF" strokeOpacity="0.5" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </div>
                )}
              </div>
            ...
            {phases.map((phase, i) => (
              <div key={phase.label} className="flex items-center gap-2">
                <div
                  ...
                  style={{ background: i === 0 ? "#47A3FF" : "rgba(255,255,255,0.2)" }}
                />
                {i < phases.length - 1 && (
